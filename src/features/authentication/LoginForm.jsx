...
function LoginForm() {
  ...
  const scope =
    "user-follow-read user-library-read playlist-read-private user-read-recently-played user-read-playback-state user-read-currently-playing user-library-modify";
