  ...
  return (
    ...
    >
      <RiSearch2Line
        ...
        className={`min-h-8 min-w-8 rounded-full p-1 text-black duration-100 md:min-h-7 md:min-w-7 dark:text-white ${!isOpen && "cursor-pointer hover:bg-white/50 hover:shadow dark:hover:bg-black/50"}`}
      />
      <div
